...
class DbHelper(val context: Context, factory: SQLiteDatabase.CursorFactory?) : SQLiteOpenHelper(context, "mobileDB", factory, 4) {

    override fun onCreate(db: SQLiteDatabase?) {
        val queryUsers = "CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT, login TEXT, email TEXT, pass TEXT)"
